...
def retrain_models(tissue, output_dir, models_keys):
    ...
    output_fn = f'{output_dir}/TS_{tissue}.h5ad'
    ...
    adata.write(f"{output_dir}/preprocessed_{tissue}.h5ad")
    ...
    if 'scvi' in models_keys:
        ...
        scvi_model.save(f"{output_dir}/{tissue}/scvi", overwrite=True, save_anndata=True)
    ...
    if 'scanvi' in models_keys:
        ...
        scanvi_model.save(f"{output_dir}/{tissue}/scanvi", overwrite=True, save_anndata=True)
    ...
    if 'condscvi' in models_keys:
        ...
        condscvi_model.save(f"{output_dir}/{tissue}/condscvi", overwrite=True, save_anndata=True)
    ...
    if 'stereoscope' in models_keys:
        ...
        stereoscope_model.save("{output_dir}/{tissue}/stereoscope", overwrite=True, save_anndata=False)
