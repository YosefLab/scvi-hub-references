...
def preprocess_adata(adata: ad.AnnData, model_dir: str) -> ad.AnnData:
    ...
    # https://github.com/Teichlab/Pan_fetal_immune/blob/master/src/02_integration_scRNA/integration_scRNA_run_scVI_subsets.py  # noqa: E501
    adata.obs["bbk"] = (
        adata.obs["method"].astype("str") + adata.obs["donor"].astype("str")
    ).astype("category")
    adata.var["GeneName"] = adata.var_names.values.copy()
